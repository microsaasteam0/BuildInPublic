...
export default function HowItWorks() {
    const steps = [
        ...
        },
        {
            icon: Cpu,
            title: "AI Synthesis",
            description: "Engine turns your daily logs into engaging build-in-public updates.",
        ...
        },
        {
            icon: Share2,
            title: "Distribute",
            description: "Get initialized X threads instantly.",
        ...
        <section className="py-16 relative overflow-hidden" id="how-it-works">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-12">
                    ...
                    >
                        Operational <span className="text-indigo-500">Protocol</span>
                    </motion.h2>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
